...
--populate reimbursement status lookup table
insert into reimbursement_status(status_id, status) values (1, 'Pending');
insert into reimbursement_status(status_id, status) values (2, 'Approved');
insert into reimbursement_status(status_id, status) values (3, 'Denied');
...
--populate reimbursement type lookup table
